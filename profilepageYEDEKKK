...
class ProfilePage(QFrame):
    ...
    def create_userBox(self):
        box = QFrame()
        box.setFixedSize(657, 701)  # Increased height for a larger profile picture
        ...
        self.profile_pic.setFixedSize(200, 150)  # Rectangle Shape
        self.profile_pic.setStyleSheet("border: 2px solid #555555; background-color: #444444;border-radius: 5px;")
    ...
    def create_book_row(self, data):
        ...
        author_pic_frame.setStyleSheet("""
            QFrame {
                background-color: transparent;  /* Let the row button's hover color shine through */
                border-radius: 10px;  /* Matches row_button border radius */
            }
        """)
